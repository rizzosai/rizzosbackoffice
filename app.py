...
def force_logout():
    ...
    <html>
    <head>
        <title>Force Logout - Rizzos AI</title>
        <style>
            body { font-family: Arial, sans-serif; background: linear-gradient(135deg, #667eea 0%, #764ba2 100%); min-height: 100vh; display: flex; align-items: center; justify-content: center; }
            .logout-box { background: white; padding: 40px; border-radius: 15px; text-align: center; max-width: 400px; }
            .login-btn { background: linear-gradient(135deg, #667eea, #764ba2); color: white; padding: 15px 30px; border: none; border-radius: 8px; text-decoration: none; display: inline-block; margin-top: 20px; }
        </style>
    </head>
    <body>
        <div class="logout-box">
            <h1>🔓 Force Logout Complete</h1>
            <p>All session data cleared.</p>
            <p>You can now login fresh or access owner account.</p>
            <a href="/login" class="login-btn">Login Again</a>
            <a href="/owner-access" class="login-btn">Owner Access</a>
        </div>
    </body>
    </html>
    """
